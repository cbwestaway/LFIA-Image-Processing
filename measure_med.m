...
%}
function [ls, props] = measure_med(filename)
    % Configurations
    th1 = 0.28125;
    th2 = 1;
    ...
    for j = 1 : n
        ...
        for i = 1 : m
            if a == 0 && mask1(i, j)
                a = i;
            elseif a > 0 && b == 0 && mask1(i, j) == 0
                b = i - 1;
            elseif c == 0 && mask2(i, j)
                c = i;
            elseif c > 0 && d == 0 && mask2(i,j) == 0
                d = i - 1;
            elseif d > 0 && e == 0 && mask2(i, j)
                e = i;
            elseif e > 0 && f == 0 && mask2(i,j) == 0
                f = i - 1;
                break
            end
        end
